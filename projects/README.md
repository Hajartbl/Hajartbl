...
Trois projets techniques **reproductibles et testés**, illustrant le passage de
la donnée brute à un livrable utile en production : pipelines ETL, ML déployé et
...
- **Tests** : chaque projet embarque une suite `pytest` (18 tests au total).
